...
const Navbar = () => {
  return (
    <>
    <nav className='flex items-center justify-between bg-[#ffffff]'>
        <div>
        ...
        <div className='flex gap-3 items-center text-center'>
            ...
            <button className='bg-[#0052FF] rounded pt-2 pl-3 pb-2 pr-3 text-[#FFFFFF] font-bold text-sm '>Get Started</button>
        </div>
    </nav>
